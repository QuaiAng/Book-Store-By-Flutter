                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text("Sign up", style: TextStyle(color: Color.fromARGB(255, 0, 7, 73)), softWrap: true,),
                      ),
                      ...
                      TextButton(
                          ...
                          child: const Text("Forgot password", style: TextStyle(color: Color.fromARGB(255, 0, 7, 73)), softWrap: true,)
                        ),
                    ],
                  ),
